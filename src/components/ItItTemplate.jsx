...
class ItItTemplate extends Component {
    constructor(props) {
        super(props);
        this.state = {
            data: null,
    ...
    componentDidMount() {
        const refNo = this.props.refNo;
        const response = getData(`/api/gatepass/getData/${refNo}`);
        const gatePass = response.data;
        this.setState({ data: gatePass });
            ...
            <PDFViewer style={{ width: '100%', height: '100vh' }}>
                <Document>
                    <Page style={styles.page}>
                        ...
                        <Text style={styles.title}>IT/{dept} Gatepass</Text>
